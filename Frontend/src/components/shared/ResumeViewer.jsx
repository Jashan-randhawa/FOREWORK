  ...
  return (
    <div className={cn("inline-flex items-center gap-2", className)}>
      <a
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md text-xs font-medium text-purple-700 bg-purple-50 hover:bg-purple-100 border border-purple-200 transition-colors dark:text-purple-300 dark:bg-purple-950/40 dark:border-purple-800"
      >
      ...
      {showDownload && (
        <a
          ...
          className="inline-flex items-center justify-center p-1 rounded-md text-gray-500 hover:text-gray-800 hover:bg-gray-100 transition-colors border border-transparent hover:border-gray-200 dark:text-gray-400 dark:hover:text-gray-200"
